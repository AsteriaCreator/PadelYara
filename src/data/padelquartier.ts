...
export const PADELQUARTIER_ENTRIES: QuartierEntry[] = [
  ...
  {
    id: "mohr-life-resort",
    name: "MOHR life resort",
    city: "Lermoos",
    bundesland: "Tirol",
    address: "Innsbrucker Straße 40, 6631 Lermoos",
    type: "hotel",
    courtInfo: "2 Indoor-Courts",
    note: "€40/Stunde, Schlägerverleih €5",
    description: "Eine historische Reithalle, umgebaut zur Padel-Arena — ganzjährig, indoor, im Zillertal-Nachbartal. Buchung nur auf Anfrage.",
    detailParagraphs: [
      "Im MOHR life resort in Lermoos wurde im Dezember 2025 die historische Reithalle des Hotels zur 'MOHR Padel Arena' umgebaut: 2 Indoor-Courts, ganzjährig bespielbar.",
      "Courtmiete €40 pro Stunde, Schlägerverleih (inkl. Bälle) €5 pro Person. Buchung nur auf Anfrage über die Rezeption — kein Online-Buchungssystem.",
    ],
    websiteUrl: "https://www.mohr-life-resort.at/mohr-activity/land/indoor-padel",
  },
  {
    id: "alpenhof-gerlos",
    name: "Alpenhof Gerlos",
    city: "Gerlos",
    bundesland: "Tirol",
    type: "hotel",
    courtInfo: "2 Outdoor-Courts",
    description: "4-Sterne-Familienhotel im Zillertal mit zwei Outdoor-Courts als Teil eines 10.000 m² großen Sportkomplexes.",
    detailParagraphs: [
      "Der Alpenhof Gerlos im Zillertal betreibt zwei Outdoor-Padelcourts als Teil seines 10.000 m² großen Sport- und Freizeitkomplexes — vom Hotel selbst als familientauglich beworben.",
      "Details zu Buchung und externem Zugang nennt die Hotelseite nicht. Kontakt: +43 5284 5374, hotel@alpenhof-gerlos.at.",
    ],
    websiteUrl: "https://www.alpenhof-gerlos.at/en/hotel/Sport_Facilities.html",
  },
  {
    id: "klosterbraeu-casa-padel",
    name: "Hotel Klosterbräu & Spa — nahe Casa Padel",
    city: "Seefeld in Tirol",
    bundesland: "Tirol",
    address: "Klosterstraße 30, 6100 Seefeld in Tirol",
    type: "hotel",
    courtInfo: "6 Indoor-Courts, ca. 900 m entfernt (nicht am Hotelgelände)",
    note: "Casa Padel — Tirols erster Indoor-Padel-Club",
    description: "Kein eigener Court, aber Tirols erster Indoor-Padel-Club liegt einen Spaziergang entfernt. Die Hotelseite schreibt '5 Minuten zu Fuß' — es sind eher 10 bis 12, auf 900 Metern.",
    detailParagraphs: [
      "Hotel Klosterbräu & Spa in Seefeld hat selbst keinen Padelcourt. Aber Casa Padel, Tirols erster Indoor-Padel-Club, liegt rund 900 Meter entfernt — 6 Indoor-Courts, Pro-Shop mit Schlägerverleih und -verkauf (Bullpadel, Head), täglich 07–23 Uhr geöffnet.",
      "Die Hotelseite bewirbt die Distanz als '5 Minuten zu Fuß' — bei 900 Metern realistischer 10 bis 12 Minuten. Buchung des Courts über die Playtomic-App.",
    ],
    websiteUrl: "https://www.klosterbraeu.com/en/active-holiday/padel-seefeld",
    internalCourtSlug: "casa-padel-seefeld",
  },
  {
    id: "padel4fun-camps",
